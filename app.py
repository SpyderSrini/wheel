...
# ── F&O Stock Universe ───────────────────────────────────────────────────────
FO_STOCKS = {
    'TCS.NS':        {'lot': 150,  'sector': 'IT'},
    'INFY.NS':       {'lot': 300,  'sector': 'IT'},
    'WIPRO.NS':      {'lot': 1500, 'sector': 'IT'},
    'HCLTECH.NS':    {'lot': 350,  'sector': 'IT'},
    'TECHM.NS':      {'lot': 700,  'sector': 'IT'},
    'LTTS.NS':       {'lot': 100,  'sector': 'IT'},
    'COFORGE.NS':    {'lot': 150,  'sector': 'IT'},
    'MPHASIS.NS':    {'lot': 175,  'sector': 'IT'},
    'PERSISTENT.NS': {'lot': 60,   'sector': 'IT'},
    'HDFCBANK.NS':   {'lot': 550,  'sector': 'Banking'},
    'ICICIBANK.NS':  {'lot': 700,  'sector': 'Banking'},
    'KOTAKBANK.NS':  {'lot': 400,  'sector': 'Banking'},
    'AXISBANK.NS':   {'lot': 1200, 'sector': 'Banking'},
    'SBIN.NS':       {'lot': 1500, 'sector': 'Banking'},
    'BAJFINANCE.NS': {'lot': 125,  'sector': 'Finance'},
    'BAJAJFINSV.NS': {'lot': 500,  'sector': 'Finance'},
    'INDUSINDBK.NS': {'lot': 700,  'sector': 'Banking'},
    'MARUTI.NS':     {'lot': 100,  'sector': 'Auto'},
    'BAJAJ-AUTO.NS': {'lot': 75,   'sector': 'Auto'},
    'EICHERMOT.NS':  {'lot': 175,  'sector': 'Auto'},
    'HEROMOTOCO.NS': {'lot': 300,  'sector': 'Auto'},
    'M&M.NS':        {'lot': 700,  'sector': 'Auto'},
    'SUNPHARMA.NS':  {'lot': 700,  'sector': 'Pharma'},
    'DRREDDY.NS':    {'lot': 125,  'sector': 'Pharma'},
    'CIPLA.NS':      {'lot': 650,  'sector': 'Pharma'},
    'DIVISLAB.NS':   {'lot': 200,  'sector': 'Pharma'},
    'LUPIN.NS':      {'lot': 500,  'sector': 'Pharma'},
    'HINDUNILVR.NS': {'lot': 300,  'sector': 'FMCG'},
    'ITC.NS':        {'lot': 3200, 'sector': 'FMCG'},
    'NESTLEIND.NS':  {'lot': 500,  'sector': 'FMCG'},
    'BRITANNIA.NS':  {'lot': 200,  'sector': 'FMCG'},
    'DABUR.NS':      {'lot': 1250, 'sector': 'FMCG'},
    'MARICO.NS':     {'lot': 1200, 'sector': 'FMCG'},
    'TATACONSUM.NS': {'lot': 900,  'sector': 'FMCG'},
    'GODREJCP.NS':   {'lot': 500,  'sector': 'FMCG'},
    'RELIANCE.NS':   {'lot': 250,  'sector': 'Energy'},
    'ONGC.NS':       {'lot': 3850, 'sector': 'Energy'},
    'NTPC.NS':       {'lot': 4500, 'sector': 'Power'},
    'POWERGRID.NS':  {'lot': 4700, 'sector': 'Power'},
    'IOC.NS':        {'lot': 2700, 'sector': 'Energy'},
    'BPCL.NS':       {'lot': 1800, 'sector': 'Energy'},
    'TATAPOWER.NS':  {'lot': 4350, 'sector': 'Power'},
    'COALINDIA.NS':  {'lot': 4200, 'sector': 'Mining'},
    'LT.NS':         {'lot': 175,  'sector': 'Infra'},
    'ULTRACEMCO.NS': {'lot': 100,  'sector': 'Cement'},
    'ADANIPORTS.NS': {'lot': 1250, 'sector': 'Infra'},
    'TATASTEEL.NS':  {'lot': 5500, 'sector': 'Metals'},
    'HINDALCO.NS':   {'lot': 2150, 'sector': 'Metals'},
    'JSWSTEEL.NS':   {'lot': 1350, 'sector': 'Metals'},
    'VEDL.NS':       {'lot': 2000, 'sector': 'Metals'},
    'NMDC.NS':       {'lot': 7500, 'sector': 'Mining'},
    'BHARTIARTL.NS': {'lot': 500,  'sector': 'Telecom'},
    'BEL.NS':        {'lot': 3500, 'sector': 'Defense'},
